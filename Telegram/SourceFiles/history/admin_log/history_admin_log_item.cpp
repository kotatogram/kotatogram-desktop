...
QString GenerateBannedChangeText(
	...
	static auto phraseMap = std::map<Flags, tr::phrase<>>{
		...
		{ Flag::SendStickers, tr::ktg_admin_log_banned_send_stickers },
		{ Flag::SendGifs, tr::ktg_admin_log_banned_send_gif },
		{ Flag::SendInline, tr::ktg_admin_log_banned_use_inline },
		{ Flag::SendGames, tr::ktg_admin_log_banned_send_games },
